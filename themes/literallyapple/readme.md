...
An Apple-inspired **liquid glass** theme for degoog: frosted translucent chrome, system typography, capsule search fields, Safari-like segmented tabs, and full-width above-results plugin slots.
